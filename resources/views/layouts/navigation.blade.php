<nav x-data="{ open: false }" class="flex bg-teal-700 border-b border-gray-100 ">
    ...
    <x-dropdown align="right" width="48">
        ...
        <x-slot name="content">
            <x-dropdown align="right" width="48">
              ...
              <x-slot name="content">
            <!-- Custom Section 1 -->
            <x-dropdown-link :href="route('FuncionEmpleado.index')">{{ __('Registro Individual') }}</x-dropdown-link>
            <x-dropdown-link :href="route('FuncionEmpleado.index')">{{ __('Consulta/Impresión') }}</x-dropdown-link>
...
<!--drop del login-->
<div class="sm:flex sm:items-center sm:ml-6  float-right" >
